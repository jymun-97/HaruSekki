...
# 📝 Summary
 ...
 레시피명을 검색하는 것에서 나아가 현재 자신이 보유한 음식 재료를 바탕으로 만들 수 있는 레시피를 검색 및 추천해주는 플랫폼. 개인의 냉장고 속 식재료 현황, 일 단위 식단표, 장보기 메모 등의 기능이 서로 동기화 되어 편리한 식단 관리 및 레시피 검색 기능을 제공하는 안드로이드 애플리케이션 입니다.
...
- **식단 관리**
    ...
    - 등록한 식단에 필요한 식재료를 ‘장보기 메모’에 자동 일괄 추가
    
     
    
- **장보기 메모**
    - 필요한 식재료를 직접 등록하거나 ‘식단 관리’로 부터 자동으로 생성
